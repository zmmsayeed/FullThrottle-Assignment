...
class Modal extends Component {
    ...
    sameDayFilter = (date) => {
        let filtered = this.props.user.activity_periods.filter(activity => {
    ...
    renderFilterData = () => {
        let filteredActivity = this.props.user.activity_periods.filter(ent => {
        ...
        if (filteredActivity.length > 0) {
            return filteredActivity.map(activity => {
                ...
                if (activityArr.includes(date)) {
                    ...
                    let filtered = this.sameDayFilter(date)
            ...
            return <p className="noActivityPara">No activity recorded for selected date</p>
        }
    }
...

                {
                    !this.props.user
                        ...
                        : <>
                            ...
                            {
                                this.state.filtered
                                    ? !this.props.user.activity_periods.length > 0
                                        ? <p className="noActivityPara">No Activities Recorded for this User</p>
